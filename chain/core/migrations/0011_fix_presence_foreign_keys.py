...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column(u'core_presencedata', 'sensor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PresenceSensor']))

    def backwards(self, orm):
        db.alter_column(u'core_presencedata', 'sensor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Sensor']))
