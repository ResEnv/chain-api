...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ScalarData', fields ['timestamp']
        db.create_index(u'core_scalardata', ['timestamp'])


    def backwards(self, orm):
        # Removing index on 'ScalarData', fields ['timestamp']
        db.delete_index(u'core_scalardata', ['timestamp'])
