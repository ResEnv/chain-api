...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename model 'Sensor':
        db.rename_table(u'core_sensor', u'core_scalarsensor')
        # Change field in ScalarData:
        db.alter_column(u'core_scalardata', 'sensor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ScalarSensor']))


    def backwards(self, orm):
        # Rename model 'Sensor':
        db.rename_table(u'core_scalarsensor', u'core_sensor')
        # Change field in ScalarData:
        db.alter_column(u'core_scalardata', 'sensor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Sensor']))
    ...
    models = {
        ...
        u'core.presencedata': {
            ...
            'presence_sensor_id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'presence_data'", 'to': u"orm['core.PresenceSensor']"}),
